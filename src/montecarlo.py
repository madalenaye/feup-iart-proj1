...
class MonteCarloNode(TreeNode):
    ...
    def _simulation_policy(self, next_moves):
    ...
    def simulate(self):
        ...
        while not current_game_state.check_win_condition() != -1:
            ...
            current_game_state = self._simulation_policy(list(get_next_moves(current_game_state)))
    ...
    def run_simulation(self, max_computation_time=5):
        """
...
if __name__ == '__main__':
    ...
    best_move = monte_carlo.run_simulation()
    print(best_move)